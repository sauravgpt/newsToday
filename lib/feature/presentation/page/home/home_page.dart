import 'dart:async';
import 'dart:io';
import 'package:newstoday/feature/presentation/bloc/topheadlinesnews/top_headlines_news_bloc.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:newstoday/feature/data/model/categorynews/category_news_model.dart';
...
import 'package:newstoday/feature/presentation/page/search/search_page.dart';
import 'package:newstoday/feature/presentation/page/settings/settings_page.dart';
import 'package:newstoday/feature/presentation/page/webView/webview_container.dart';
import 'package:newstoday/feature/presentation/widget/widget_failure_message.dart';
import 'package:newstoday/feature/presentation/widget/widget_item_news.dart';
import 'package:newstoday/injection_container.dart';
        ...
        child: BlocListener<TopHeadlinesNewsBloc, TopHeadlinesNewsState>(
            ...
            if (state is FailureTopHeadlinesNewsState) {
              ...
              if (Platform.isIOS) {
                ...
                topHeadlinesNewsBloc
                    .add(LoadTopHeadlinesNewsEvent(category: category));
              } else {
                refreshIndicatorState.currentState.show();
              }
            }
          ...
          child: ValueListenableBuilder(
            ...
            builder: (context, box, widget) {
              isDarkMode = box.get('darkMode') ?? false;
              return Stack(
                children: [
                  Container(
      ...
      onTap: () async {
        if (await canLaunch(itemArticle.url)) {
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      WebViewContainer(itemArticle.url, isDarkMode)));
        } else {
          ...
          return Padding(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                topHeadlinesNewsBloc.add(
                  ChangeCategoryTopHeadlinesNewsEvent(
